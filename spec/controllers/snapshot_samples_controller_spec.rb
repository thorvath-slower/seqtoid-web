  ...
  context "when snapshot sharing is enabled" do
    ...
    describe "GET #metadata" do
      ...
      it "should return the correct json_response for valid share_id" do
        ...
        expected_pipeline_run_keys = ["adjusted_remaining_reads", "alert_sent", "alignment_config_id", "assembled", "created_at", "deprecated",
                                      ...
                                      "unmapped_bases", "deleted_at", "mapped_reads", "results_load_retry_count",]
