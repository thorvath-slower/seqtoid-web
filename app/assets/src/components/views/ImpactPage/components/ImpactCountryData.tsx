...
export const ImpactCountryData = [
  ...
  },
  {
    ...
    summary: `Central nervous system (CNS) diseases such meningoencephalitis (ME) are  associated with significant mortality and morbidity in tertiary neurointensive care settings in India. Etiological diagnosis of ME in such settings represents a formidable problem, as the number of causative organisms vastly outnumbers the available diagnostic tests on the market. This team will use SeqtoID to study the etiology of undiagnosed ME infection in a tertiary health care setting.
    `,
    cycle: 2,
    mapPosition: {
      bottom: "45%",
  ...
  },
  {
    ...
    summary: `Over the last decade, the global community has seen a resurgence of known viruses, as well as the emergence of novel viruses. Kenya, in particular, has experienced numerous outbreaks caused by arboviruses and other viral infectious pathogens. This study will develop a targeted viral enrichment protocol for metagenomic sequencing of known and novel arbovirus and viral hemorrhagic fever pathogens. Researchers will apply this method with SeqtoID to screen and characterize pathogenic viruses in samples from routine disease surveillance and new outbreaks.
    `,
    cycle: 2,
    mapPosition: {
      bottom: "35.5%",
  ...
  },
  {
    ...
    summary: `Like many bats worldwide, fruit bats in Madagascar act as reservoirs for viruses of high zoonotic potential, including close relatives of Ebola and SARS-CoV. Identifying novel bat viruses that transmit to humans via traditional diagnostic methods requires the development of targeted assays and is laborious and inefficient. This project will use SeqtoID to analyze archived, human clinical samples from febrile patients for possible infection with novel, emerging bat pathogens.
    `,
    cycle: 1,
    mapPosition: {
      bottom: "25%",
  ...
  },
  {
    ...
    summary: `Neuroinfection occurs when bacteria, viruses, fungi, or parasites attack the brain and/or spinal cord, which can lead to long-term disability and death. The causes of 60-80% of neuroinfection cases remain unknown, especially as commercial diagnostic tests often do not detect diseases seen in developing countries, including mosquito-borne viruses like dengue and chikungunya viruses, infections of animal origin such as Leptospira, and newly emerging or re-emerging pathogens like Zika virus. This project will use metagenomic sequencing with SeqtoID to identify and characterize a broad range of existing and emerging infectious diseases in a tropical setting.`,
    cycle: 2,
    mapPosition: {
      bottom: "37%",
      left: "74.5%",
  ...
  },
  {
    ...
    summary: `Acute encephalitis syndrome (AES) affects over 100,000 individuals in low- and middle-income countries annually, causing substantial morbidity and mortality. This complex disease can be caused by over 100 different pathogens, including viruses and parasites — making accurate diagnosis difficult and hindering prevention and treatment efforts. To better characterize the pathogens causing AES, this project will focus on using SeqtoID to analyze cerebral spinal fluid samples collected from fatal acute encephalitis cases, with the goal of validating and refining their diagnostic methods.`,
    cycle: 1,
    mapPosition: {
      bottom: "51%",
      left: "69.5%",
  ...
  },
  {
    ...
    summary: `Nosocomial infections cause substantial morbidity and mortality in Senegal but aren’t well-understood. Testing is often done through classical diagnostic methods, such as microscopy and culture, which are often unable to detect pathogens —  resulting in an underestimation of the frequency of cases. This team will use SeqtoID to identify and characterize microorganisms responsible for nosocomial infections and suitable specimens to improve diagnosis and treatment.`,
    cycle: 2,
    mapPosition: {
      bottom: "46.7%",
      left: "42.5%",
  ...
  },
  {
    ...
    summary: `Globally, there are around 2.5 million neonatal deaths and 2.6 million stillbirths annually — the vast majority occurring in low- to middle-income countries. Conventional methods have shown that infectious pathogens cause far more of these deaths than previously thought, and that many cases may be linked to multi-drug resistant organisms, hospital-acquired infections. This project will apply SeqtoID to archived blood samples from stillbirths and analyze the results to identify novel, unculturable, or untargeted pathogens that were not identified using  more traditional microbiological methods.`,
    cycle: 1,
    mapPosition: {
      bottom: "18%",
      left: "53%",
  ...
  },
  {
    ...
    summary: `Encephalitis, an inflammation of the brain commonly caused by viral infections, is a major contributor to childhood morbidity and mortality worldwide. Treatment requires rapid diagnosis; however, traditional diagnostic methods identify less than half of cases. Further confounding accurate diagnosis is the emergence of new and diverse pathogens that cause encephalitis. This project will focus on using SeqtoID to analyze retrospectively-collected samples from children presenting with encephalitis in order to identify the major causes of encephalitis and understand disease outcomes.`,
    cycle: 1,
    mapPosition: {
      bottom: "43.5%",
      left: "76.1%",
