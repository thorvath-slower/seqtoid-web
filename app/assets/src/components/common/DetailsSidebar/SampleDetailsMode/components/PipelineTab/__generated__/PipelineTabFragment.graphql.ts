...
export type PipelineTabFragment$data = {
  ...
  readonly " $fragmentType": "PipelineTabFragment";
};
export type PipelineTabFragment$key = {
  readonly " $data"?: PipelineTabFragment$data;
